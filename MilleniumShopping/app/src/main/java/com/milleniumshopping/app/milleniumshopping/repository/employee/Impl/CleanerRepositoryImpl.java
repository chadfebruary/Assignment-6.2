 ...
 */
public class CleanerRepositoryImpl extends SQLiteOpenHelper implements CleanerRepository {
    ...
    public CleanerRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    public CleanerRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
    ...
    @Override
    public Cleaner findById(String employeeID, String role)
    {
        ...
        {
            final Cleaner employee = new Cleaner.Builder()
    ...
    @Override
    public Cleaner save(Cleaner employee)
    {
        open();
        onCreate(database);
        ...
        final Cleaner insertedEntity = new Cleaner.Builder()
                .copy(employee)
    ...
    @Override
    public Cleaner update(Cleaner employee)
    {
        open();
        ContentValues values = new ContentValues();
    ...
    @Override
    public Cleaner delete(Cleaner employee)
    {
        open();
        database.delete(
                TABLE_EMPLOYEE,
    ...
    @Override
    public Set<Cleaner> findAll()
    {
        open();
        String selectAll = " SELECT * FROM " + TABLE_EMPLOYEE;
        Set<Cleaner> employees = new HashSet<>();
        //open();
