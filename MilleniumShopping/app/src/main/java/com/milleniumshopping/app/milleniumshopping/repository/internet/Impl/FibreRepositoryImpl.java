 ...
 */
public class FibreRepositoryImpl extends SQLiteOpenHelper implements FibreRepository {
    ...
    public FibreRepositoryImpl(Context context)
    {
        super(context, DBConstants.DATABASE_NAME, null, DBConstants.DATABASE_VERSION);
    }

    public FibreRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    public FibreRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
    ...
    @Override
    public Fibre findById(String ipAddress, String type)
    {
        ...
        {
            final Fibre internet = new Fibre.Builder()
    ...
    @Override
    public Fibre save(Fibre internet) {
        open();
        onCreate(database);
        ...
        final Fibre insertedEntity = new Fibre.Builder()
                .copy(internet)
    ...
    @Override
    public Fibre update(Fibre internet) {
        open();
        ContentValues values = new ContentValues();
    ...
    @Override
    public Fibre delete(Fibre internet){
        open();
        database.delete(
                TABLE_INTERNET,
                COLUMN_IPADDRESS + " =? ",
    ...
    @Override
    public Set<Fibre> findAll() {
        open();
        String selectAll = " SELECT * FROM " + TABLE_INTERNET;
        Set<Fibre>internetServices = new HashSet<>();
