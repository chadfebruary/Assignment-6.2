...
public class ManagerRepositoryImpl extends SQLiteOpenHelper implements ManagerRepository {
    ...
    public ManagerRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    public ManagerRepositoryImpl(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
    ...
    @Override
    public Manager findById(String employeeID, String role)
    {
        ...
        {
            final Manager employee = new Manager.Builder()
    ...
    @Override
    public Manager save(Manager employee)
    {
        open();
        onCreate(database);
        ...
        final Manager insertedEntity = new Manager.Builder()
                .copy(employee)
    ...
    @Override
    public Manager update(Manager employee)
    {
        open();
        ContentValues values = new ContentValues();
    ...
    @Override
    public Manager delete(Manager employee)
    {
        open();
        database.delete(
                TABLE_EMPLOYEE,
